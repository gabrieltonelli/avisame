...
class _TextNotificationScreenState extends State<TextNotificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final String baseUri = 'https://avisame.app/restapi/v1/notificaciones';

    _sendNotification(String observacion) async {

      var response = await http.post(Uri.encodeFull(baseUri + '?id_tarea=' + widget.tarea.idTarea.toString()
                    + '&tipo=1'
      ...
      child:
            ...
            TextField(
              ...
              decoration: new InputDecoration(
                ...
                filled: true,
                contentPadding:
                EdgeInsets.only(bottom: 20.0, left: 20.0, right: 20.0, top: 20.0),
