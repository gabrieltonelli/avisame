...
//import 'package:avisame4/misc/my_library.dart';
...
class UploadImageDemoState extends State<UploadImageDemo> {
  //
  static final String uploadEndPoint = 'https://avisame.app/restapi/v1/upload.php';
  Future<File> file;
  String status = '';
  String base64Image;
  File tmpFile;
  ...
  chooseImage() {
    setState(() {
      file = ImagePicker.pickImage(source: ImageSource.gallery,maxWidth: 1280.0,maxHeight: 1280.0);
    });
    setStatus('');
  }
  ...
  final String postUri = 'https://avisame.app/restapi/v1/notificaciones';
  ...
  _sendNotification(String image_url) async {
    ...
    if (response.statusCode == 201) {
      ...
      Scaffold.of(context).showSnackBar(
          SnackBar(content: Text("Error al enviar foto")));
    }
  }
